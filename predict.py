import feature, const, dto, rules_new
...
def predict_category(normalizedAttr, product_id=None, item_id=None, garbage_filter=True, top=1):
    ...
    return pred_final.get_lv1_catecode(), pred_final.get_lv2_catecode(),\
         pred_final.get_lv3_catecode(), pred_final.get_lv4_catecode(),\
         pred_final.get_lv5_catecode(), pred_final.get_lv6_catecode(),\
         str(pred_final.get_lv1_score()), str(pred_final.get_lv2_score()),\
         str(pred_final.get_lv3_score()), str(pred_final.get_final_score())\
